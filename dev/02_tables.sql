...
SET search_path TO safeflow, public;
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    CONSTRAINT transactions_confirmed_status_check CHECK (
        confirmed_at IS NULL OR status IN ('WARNED', 'SETTLED')
    ),
    CONSTRAINT transactions_settled_status_check CHECK (
...
-- updated_at trigger reutilizabil.
